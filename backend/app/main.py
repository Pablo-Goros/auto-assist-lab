...
from app.routers import admin, me, operator, service_requests, tenants, workshops
...
app = FastAPI(
    ...
    description=(
        ...
        "Firebase establishes identity and PostgreSQL establishes application roles."
    ),
    version="0.1.0",
    lifespan=lifespan,
)
